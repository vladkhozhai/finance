...
const TEMPLATE_VISUALS: Record<string, { color: string; gradient: string }> = {
  ...
  elegant: {
    color: "bg-yellow-700",
    gradient: "from-amber-100 to-yellow-700",
  },
  designer: {
    color: "bg-pink-500",
      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900">
        ...
        <main className="container mx-auto px-4 py-8 flex items-center justify-center min-h-[calc(100vh-80px)]">
          <div className="text-center">
            ...
            <h2 className="text-lg font-semibold mb-2">Loading templates</h2>
            <p className="text-muted-foreground">Finding the perfect design for your CV...</p>
          </div>
        </main>
      </div>
    );
          ...
          {templates.map((template) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`h-48 bg-gradient-to-br ${visual.gradient} relative transition-transform duration-300 group-hover:scale-105`}
                >
                  {/* Mock CV Preview */}
                  <div className="absolute inset-4 bg-white/10 backdrop-blur-sm rounded-lg p-4 transition-all duration-300 group-hover:bg-white/20">
                  ...
                  {/* Selected Badge */}
                  {isSelected && (
                    <div className="absolute top-3 right-3 animate-in fade-in-50 zoom-in-95">
