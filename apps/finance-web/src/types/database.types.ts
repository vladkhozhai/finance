...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      get_active_currencies: { Args: never; Returns: string[] }
      get_exchange_rate: {
        Args: {
          p_date?: string
          p_from_currency: string
      ...
      get_first_day_of_month: { Args: { p_date: string }; Returns: string }
      get_last_day_of_month: { Args: { p_date: string }; Returns: string }
      ...
      get_user_favorite_templates_count: {
        Args: { p_user_id: string }
        Returns: number
      }
      mark_stale_rates: { Args: never; Returns: number }
    }
    Enums: {
      [_ in never]: never
    }
